...
export function Footer() {
  ...
  return (
    <footer className="bg-white dark:bg-background text-foreground border-t border-border">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 bg-muted hover:bg-primary text-muted-foreground hover:text-white rounded-full flex items-center justify-center transition-all border border-transparent dark:border-border"
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-bold mb-6 text-foreground uppercase tracking-wider text-sm">
              {tn('home')}
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-4 text-muted-foreground font-medium">
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+905302844553" className="hover:text-primary transition-colors">
                  0530 284 45 53
                </a>
              </li>
              <li className="flex items-center gap-3">
